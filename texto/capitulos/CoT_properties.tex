...
\input{capitulos/primitives/flags}

\subsection*{Preserve and ignore coordinates through ATTN and FF}

\input{capitulos/primitives/preserve_coordinates.tex}
...
\input{capitulos/primitives/linear-transf}
...
\input{capitulos/normalization.tex}
