...
We will construct a layer such that $FF(h) = \mathbb{I}(h \text{ is flagged})\cdot v$.
...
\begin{align*}
    ...
    \end{matrix}\right) 
\end{align*}
\santi{me perdí. ¿Qué son $b_1, b_2$?}
...
\santi{explicar mejor. Poner ejemplos. La fórmula que sigue parece colgada.}
