...
We give a construction for taking the maximum of two coordinates, but it can be extended to a larger set by repeating the operation as a tournament.
\rafa{no es torneo, es solo probar todos los caso en las indicatrices}
