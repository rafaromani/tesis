...
\begin{align*}
    ...
    \left( \begin{matrix} a \\ b \\ \maxrep \times \mathbb{I}(a>b) \\ \maxrep \times \mathbb{I}(b>a) \\ \vdots \\ \end{matrix} \right) \longrightarrow 
    \\
    ...
    \left( \begin{matrix} a \times \mathbb{I}(a>b) \\ b \times \mathbb{I}(b>a) \\ 0 \\ 0 \\ \vdots \\ \end{matrix} \right)
    = \begin{cases}
...
\begin{equation*}
    ...
    \xrightarrow[\text{operation}]{\text{Special}}
    \left(\begin{matrix}
        a \times \mathbb{I}_a \\ b \times \mathbb{I}_b\\ 0 \\ 0
    \end{matrix}\right)
\end{equation*}
...
\begin{equation*}
    ...
    \xrightarrow[\text{operation}]{\text{Special}}
    \left(\begin{matrix}
        a            &+& \maxrep \times \mathbb{I}_b &+& \maxrep \times \mathbb{I}_b &+& \minrep \times \mathbb{I}_b \\
        b            &+& \maxrep \times \mathbb{I}_a &+& \maxrep \times \mathbb{I}_a &+& \minrep \times \mathbb{I}_a \\ 
...
\noindent Notice that the output of this $\FF$ layer when inputted with $(a, b, \mathbb{I}_a, \mathbb{I}_b)$ will be $(\maxrep \times \mathbb{I}_b, \maxrep \times \mathbb{I}_a, 0, 0)$.
...
\noindent which inputted with $(x, y, \mathbb{I}_a, \mathbb{I}_b)$, it will output $(\minrep \times \mathbb{I}_b, \minrep \times \mathbb{I}_a, -\mathbb{I}_a, -\mathbb{I}_b)$