...
Notice that one of $\mathbb{I}_a$ and $\mathbb{I}_b$ is a $1$ and the other is a $0$.
...
\noindent Notice that the output of these $\FF$ layer when inputted with $(x, y, \mathbb{I}_a, \mathbb{I}_b)$ will be $(\maxrep \cdot \mathbb{I}_b, \maxrep \cdot \mathbb{I}_a, 0, 0)$.
