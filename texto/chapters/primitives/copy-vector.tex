...
For example if we were looking for copying the $k$th coordinate of $v_i$ to the $l$th coordinate of $v_j$, the matrix will have $0$ en every coordinate and $1$ in the row $l$ column $k$.
