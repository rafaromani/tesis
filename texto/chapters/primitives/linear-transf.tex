...
We will do use two consecutive $\ATTN$ layers where the $f$th \santi{Podés no dar bola, pero $f$ no es un buen nombre para una coordenada. ¿Qué tal $i,j,k,r,s,u,v$?}vector will only attend to itself.
