There are going to be constructions were we would like to be able to, once the transformer prints a token, repeat it indefinitely.\santi{de nuevo, redacción recargada. Otra cosa: ¿"indefinitely" qué quiere decir? ¿Es una cantidad fija pero arbitraria de veces?}
...
We make them $0$ using a constant function as described in a previous section.\santi{aca, ser más preciso. Se puede dar el número de sección (si les ponés números)}
