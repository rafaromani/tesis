...
\begin{theorem}[$\RCoTtndn$ is closed under complement]
    \leavevmode\\
    \indent $\gL \in \RCoTtndn \implies \gL^c \in \RCoTtndn$
\end{theorem}
...
\begin{theorem}[$\RCoTtndn$ is closed under disjunction]
    \leavevmode\\
    \indent $\gL_1, \gL_2 \in \RCoTtndn \implies \gL_1 \cup \gL_2 \in \RCoTtndn$
\end{theorem}
...
Then, the probability of $\{\TF_n\}_{n \in \mathbb{N}}$ answering $\gL_1 \cup \gL_2$ correctly is higher than $1/2$ (see Appendix \ref{appendix:calculations-prob-or}).
