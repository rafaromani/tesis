...
\bigrafa{Pero mi def pide mayor estricto a la constante.}
...
We construct $\TF'_n$ based on $\TF_n$ using a Majority Vote simulation.
...
After calculations, it holds that $r = O(1)$ (since both $c$ and $d$ are fixed).
Thus, only a constant number of runs are needed for the construction to work properly.
