...
hus, for probabilistic transformers, we define normalization solely as the condition \projection.
...
Observe that the algorithm presented in Section \ref{normalization} for constructing equivalent transformers satisfying \projection\ in the deterministic setting also applies to probabilistic transformers.