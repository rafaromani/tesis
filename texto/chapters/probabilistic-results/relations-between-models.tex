...
\bigcifu{comentario bardero, borrar}
...
\bigcifu{Acá podrias comentar que si bien la opinión sobre P = BP P no es tan unánime como en N P , hay un acuerdo que BP P te da beneficios polinomiales. Eso implica que para hacer fine-grained complexity es importante tener en cuenta que el COT sea probabilistico. Eso impacta entonces en trabajos recientes donde hacen fine-grained complexity. Creo que este hace eso: Lower Bounds for Chain-of-Thought Reasoning in Hard-Attention Transformers}