...
First, the computation of the probability distribution over the alphabet which we call distribution generation.
...
The dimension is dependent on the size of the input word. \footnote{This is note the case in the real models since the same model is used for all input sizes.}
...
Figure \ref{diag-transf} shows how the token selector connects with the distribution generator and its components.
