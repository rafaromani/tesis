...
We split the process of generating the next token in two separated steps.
...
Second, the selection of the token based on the probability distribution, which we call token by a process called token selection.
...
On the other hand, the probabilistic selector works non-deterministically.
