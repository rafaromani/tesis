...
In the case of $\AC^0$ and $\BPAC^0$, restricting $\BPAC^0$ to only $O(\log(n))$ random bits is enough to be make it fall inside $\AC^0$.
...
Clearly $(\ppoly)/\mathsf{poly} = \ppoly$; thus, from Adleman's theorem its deduced the following corollary:
