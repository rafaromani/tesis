...
An interesting result from descriptive complexity is that for all $e > 0$, there is a circuit in $\AC^0$ recognizing $\PROMISEDMAJORITY{e}$ \citep{viola2009approximate}.
