\citet{toyota} also prove a lower bound on the expressiveness of constant-depth, constant-precision deterministic transformers using $\CoT$ with $O(\log(n))$ embedding size (Theorem \ref{det-lower-bound}).
...
\bigcifu{Tenían algun dibujo bueno para robar?}
