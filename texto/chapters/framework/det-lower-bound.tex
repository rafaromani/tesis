\cite{toyota} also prove a lower bound on the expressiveness of constant-depth, constant-precision transformers using $\CoT$ with $O(\log(n))$ embedding size (Theorem \ref{det-lower-bound}).
