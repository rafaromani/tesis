\begin{theorem}\label{sim-circ-by-det-transf}
    Any family of circuits of polynomial size $T(n)$ can be simulated by a constant-depth, constant-precision deterministic transformers using $\CoT$ with $O(\log(n))$ embedding size 
\end{theorem}
