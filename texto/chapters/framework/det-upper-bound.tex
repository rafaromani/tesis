...
This result is built on the fact that multiplication and division of $n$-bit binary numbers are in $\TC^0$ \citep{hesse2001division}, as well as the iterated addition over $n$ different $n$-bit binary integers.
...
\bigcifu{A mi me gustaría ponerle más importancia al párrafo que está abajo. Onda, me parece un primer resultado no trivial, con un argumento atractivo. Por más que no sea nuestro, es una primera aplicación real que se puede enunciar con las definciones que armaste. Con un ambiente de proof me parece que queda claro que es importante.}
