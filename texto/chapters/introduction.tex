...
The tokenizing process is not of interest since it is just a way of splitting the human text into something the transformers can understand; thus, in this thesis (and in all the papers of the area) it is assumed that the user talks in tokens, i.e., the transformers receive tokens in their input tape.
...
In this way, the LLMs like ChatGPT generate the text that they answer to user's prompts.
