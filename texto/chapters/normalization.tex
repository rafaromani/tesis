...
Now, if the maximum is positive, multiplying by $\maxrep$, then subtracting $1$ and multiplying by $\maxrep$ again gets us what we wanted.
...
Our algorithm will do the following (where $\relu$ is applied position wise):
